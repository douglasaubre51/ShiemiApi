...
namespace ShiemiApi.Migrations
{
    ...
    [Migration("20260323171851_Added Tags in Project model")]
    partial class AddedTagsinProjectmodel
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ShiemiApi.Models.Dev", b =>
                {
                    ...
                    b.PrimitiveCollection<List<string>>("DevTags")
                        .HasColumnType("text[]");
            ...
            modelBuilder.Entity("ShiemiApi.Models.Project", b =>
                {
                    ...
                    b.PrimitiveCollection<List<string>>("ProjectTags")
                        .HasColumnType("text[]");
